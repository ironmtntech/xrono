Feature: Search Work Units
  ...
  Scenario: Search for all work units containing a particular paid string
    ...
    And a project "test project" exists with name: "test project", client: client "test client"
    And a ticket "test ticket" exists with project: project "test project", name: "test ticket"
    And a work_unit "test work unit" exists with ticket: ticket "test ticket", scheduled_at: "2010-01-01", hours: "1", paid: "12"
    And a work unit "test work unit2" exists with ticket: ticket "test ticket", scheduled_at: "2010-01-01", hours: "1", paid: "12"
